        ...
        <div>
                <Form>
                    <Form.Group>
                        ...
                        De: <Form.Range min={10000} step={10000} max={1000000} value={startPrice} onChange={e => setStartPrice(Number(e.target.value))} />{startPrice}<br />
                        Até: <Form.Range min={10000} step={10000} max={1000000} value={endPrice} onChange={e => setEndPrice(Number(e.target.value))} />{endPrice}
                    </Form.Group>
                    <hr />
                    <Form.Group>
